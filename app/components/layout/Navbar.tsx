    ...
    <>
      <nav className={`gyf-nav${scrolled ? " scrolled" : ""}`}>
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "0.65rem", textDecoration: "none" }}>
          <Image src="/assets/logo-new.png" alt="GYF" width={36} height={36} priority style={{ objectFit: "contain" }} />
        </Link>
      ...
      {menuOpen && (
        ...
        >
          ...
          >
            <Image src="/assets/logo-new.png" alt="GYF" width={32} height={32} style={{ objectFit: "contain" }} />
            <button
