    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6 pt-32 pb-20">
        ...
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-violet-200 bg-violet-50 text-violet-700 text-sm font-mono mb-8">
        ...
        <motion.h1 initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.8,delay:0.1}}
          className="text-[clamp(3rem,8vw,7rem)] font-black leading-[0.9] tracking-tight text-gray-900 mb-6"
        ...
        <motion.p initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.8,delay:0.3}}
          className="text-[clamp(1rem,2vw,1.25rem)] text-gray-700 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.8,delay:0.5}}
          ...
          <a href="#perception" className="btn-3d px-8 py-4 font-semibold text-white bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-500 hover:to-pink-500 transition-all duration-300">
            Get Early Access
          </a>
        ...
        <motion.div initial={{opacity:0,y:40}} animate={{opacity:1,y:0}} transition={{duration:1,delay:0.7}}
          ...
          <div className="glass-card gradient-border-card p-6 glow-purple">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-3 h-3 rounded-full bg-red-500/60" />
              <div className="w-3 h-3 rounded-full bg-yellow-500/60" />
              <div className="w-3 h-3 rounded-full bg-green-500/60" />
              <span className="ml-2 text-xs text-gray-700 font-mono">GYF Stylist</span>
            </div>
            <div className="grid grid-cols-3 gap-3">
              {['Top', 'Bottom', 'Footwear'].map((item, i) => (
                <div key={item} className="rounded-xl bg-gray-50 border border-gray-200 p-4 text-center backdrop-blur-sm">
            ...
            <div className="mt-4 p-3 rounded-lg bg-purple-500/10 border border-purple-500/20">
              <p className="text-xs text-violet-700 font-mono">&quot;Structured silhouette suits your inverted triangle build. Navy anchors the palette.&quot;</p>
            </div>
          </div>
        </motion.div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-3 gap-6">
          {[
            ...
            <div key={stat.label} className="text-center">
              ...
              <div className="text-xs text-gray-700 mt-1 uppercase tracking-widest">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
