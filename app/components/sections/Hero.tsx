    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0A0A14]">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6 pt-32 pb-20">
        ...
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.8,delay:0.5}}
          ...
          <a href="#perception" className="btn-3d px-8 py-4 font-semibold text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 transition-all duration-300">
            Get Early Access
          </a>
          <a href="#how-it-works" className="px-8 py-4 rounded-full font-semibold text-gray-300 border border-white/10 hover:border-white/20 hover:text-white transition-all duration-300 bezel">
            See How It Works ↓
          </a>
        </motion.div>
          ...
          <div className="glass-card gradient-border-card p-6 glow-purple">
            ...
            <div className="grid grid-cols-3 gap-3">
              {['Top', 'Bottom', 'Footwear'].map((item, i) => (
                <div key={item} className="rounded-xl bg-white/5 border border-white/10 p-4 text-center backdrop-blur-sm">
