    ...
    <section className="py-32 px-6 bg-surface border-t border-border">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          >
            Everyone knows this feeling. Shopping apps show individual items but never how to wear
            them together. Every morning brings the same quiet friction: Does this match? Is it
          ...
          >
            A personal stylist — someone who knows what flatters you — has always been a luxury for
            the few. GYF was built to end that.
          </p>
        </motion.div>
      </div>
    </section>
